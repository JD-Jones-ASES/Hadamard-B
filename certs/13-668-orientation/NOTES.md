...
* Nothing about the orientation switch at 716, 1676 or 1772 — the same
  construction exists there and the same computation costs about 1.3×, 98×
  and 130× this one; not made, so not said.
