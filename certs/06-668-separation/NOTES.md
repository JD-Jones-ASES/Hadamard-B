...
* **Nothing about orders 716, 1676 or 1772.** The same construction gives
  ...
  nothing about them. The `716` and `1676` computations have since been made
  and carry their own certificates — cert 11 (NOTE-B.md §3.6) and cert 20
  (NOTE-B.md §3.7, row-side only); `1772` has not been made, so nothing is
  said there.
