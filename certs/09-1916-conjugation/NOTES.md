...
* **Nothing about `ψ(ρ) = −1` in general.** The proposition's proof breaks
  there, and at orders 668, 716, 1676 and 1772 that case provably **does**
  leave the equivalence class (certs 06 and 08; cert 11; cert 20; cert 23).
  Whether it always does is not claimed; those four are the proven cases,
  and four cases are four cases.
